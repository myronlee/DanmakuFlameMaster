...
import com.alipay.mobile.beehive.compositeui.danmaku.model.android.AndroidDisplayer;
...
import com.alipay.mobile.beehive.compositeui.danmaku.util.DeviceUtils;
...
//                : new DrawTask(timer, context, mDisp, taskListener);
        IDrawTask task = new DrawTask(timer, context, mDisp, taskListener);
