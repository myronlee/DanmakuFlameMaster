...
package com.alipay.mobile.beehive.compositeui.danmaku.renderer.android;
...
import com.alipay.mobile.beehive.compositeui.danmaku.util.DanmakuUtils;
...
public class DanmakusRetainer {
    ...
    private static class RLDanmakusRetainer implements IDanmakusRetainer {
        ...
        protected float checkVerticalEdge(boolean overwriteInsert, BaseDanmaku drawItem,
            ...
            if (topPos < 0 || (firstItem != null && firstItem.getTop() > 0) || topPos + drawItem.paintHeight > disp.getHeight()/2) {
                topPos = 0;
                clear();
            }
            return topPos;
